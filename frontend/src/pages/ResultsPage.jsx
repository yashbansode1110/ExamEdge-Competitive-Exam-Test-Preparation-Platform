...
export function ResultsPage() {
  ...
  const { score, accuracy, testId } = location.state || { score: 0, accuracy: 0 };

  const accuracyPct = accuracy <= 1.01 ? accuracy * 100 : accuracy;

  // Mock results data
  const results = {
    score: score || 240,
    maxScore: 300,
    accuracy: Number.isFinite(accuracyPct) && accuracyPct > 0 ? accuracyPct : 80,
    timeSpent: 125,
    totalTime: 180,
    ranking: 1250,
